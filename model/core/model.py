...
class MoNODE(nn.Module):
    ...
    def forward(self, X, L=1, T_custom=None):
        ...
        if self.is_inv:
            ...
            c, m = InvMatrix[:, :, :self.inv_enc.content_dim], InvMatrix[:, :, self.inv_enc.content_dim:] #*#
            mean_est, cov_est = self.inv_enc.inv_encoder.mean_est, self.inv_enc.inv_encoder.cov_est #*#
        else:
        ...
        return Xrec, ztL, (s0_mu, s0_logv), (v0_mu, v0_logv), InvMatrix, c, m, mean_est, cov_est #*#
